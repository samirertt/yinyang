        ...
        <div className="navBarContainer" style={{display:'flex', gap:'20px',padding:'10px',alignContent:'center'}}>
            ...
            {isAdmin && (
              <div className='flex items-center gap-5'>
                <Link style={{margin:'0px',padding:'0px'}} to="/AdminDashboard/Characters"><button className='rounded-xl bg-[#ffffff] text-[#303136] cursor-pointer px-[10px] py-[5px]'>Characters</button></Link>
                <Link style={{margin:'0px',padding:'0px'}} to="/AdminDashboard/Edit"><button className='rounded-xl bg-[#ffffff] text-[#303136] cursor-pointer px-[10px] py-[5px]'>Users</button> </Link>
              </div>
            )}
